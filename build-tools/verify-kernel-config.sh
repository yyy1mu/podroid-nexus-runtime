...
for option in \
    OF ARM_PSCI_FW ARM_GIC ARM_GIC_V3 ARM_ARCH_TIMER PCI PCI_MSI PCI_HOST_GENERIC \
...
for option in \
    ...
    NUMA_BALANCING HOTPLUG_CPU MEMORY_HOTPLUG COMPAT CGROUPS \
    VIRTIO_PCI_LEGACY AUDIT STACKPROTECTOR FORTIFY_SOURCE \
