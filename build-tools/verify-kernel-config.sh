...
for option in \
    ...
    PROC_FS SYSFS POSIX_MQUEUE NET_9P NET_9P_VIRTIO 9P_FS \
    SWAP ZSMALLOC ZRAM ZRAM_BACKEND_LZ4 \
...
for option in \
    ...
    NETFILTER FUSE_FS BTRFS_FS DRM FB THERMAL \
...
printf 'Verified monolithic QEMU-virt kernel: 0 modules, 9P, TUN/TAP and TBF built in.\n'
